...
distf = curve1 - curve2; 
plot(time,curve1,time,curve2); %plotting curve1 and curve 2 
title('Object 1 vs Object 2')
xlabel('Time (s)');
ylabel('Distance (m)');
legend('Object 1','Object 2');
figure 
plot (time,distf); %plotting 
title('Distance Traveled');
xlabel('time (s)');
ylabel('Distance (m)');
fprintf('Final Distance is:%0.01f \n',distf(end)); %displaying the end of the distf vector 